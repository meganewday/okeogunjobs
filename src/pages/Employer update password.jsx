...
export default function EmployerUpdatePassword() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      navigate('/employer/login?reset=success')
    } catch (err) {
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>
          Choose a new password for your employer account. It must be at least
          8 characters.
        </p>
