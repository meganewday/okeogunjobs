...
const styles = {
  ...
  // About
  aboutGrid: { display: 'grid', gridTemplateColumns: '1fr', gap: '40px', alignItems: 'start', maxWidth: '680px' },
  aboutText: {},
  ...
  jobCard: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', backgroundColor: '#f9f9f9', borderRadius: '10px', border: '1px solid #eee', cursor: 'pointer', transition: 'background 0.15s ease' },
  jobCardLeft: {},
