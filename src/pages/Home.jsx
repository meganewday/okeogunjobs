...
import { APP_NAME, APP_REGION } from '../config/constants'
        ...
        <div style={styles.sectionInner}>
          <div style={styles.aboutGrid}>
            <div style={styles.aboutText}>
              <h2 style={styles.sectionTitle}>What is {APP_NAME}?</h2>
            ...
            <div style={styles.aboutCards}>
              <div style={styles.aboutCard}>
                ...
                <h4 style={styles.aboutCardTitle}>Reviewed Listings</h4>
                <p style={styles.aboutCardText}>Every job and every profile is checked before it goes live</p>
              </div>
              <div style={styles.aboutCard}>
                <span style={styles.aboutCardIcon}>🆓</span>
                <h4 style={styles.aboutCardTitle}>Free for Everyone</h4>
                <p style={styles.aboutCardText}>No charges for job seekers. Posting a job costs nothing either</p>
              </div>
              <div style={styles.aboutCard}>
                <span style={styles.aboutCardIcon}>📍</span>
                <h4 style={styles.aboutCardTitle}>Built for Oke-Ogun</h4>
                <p style={styles.aboutCardText}>9 LGAs covered. Not a general platform retrofitted to fit</p>
              </div>
              <div style={styles.aboutCard}>
                <span style={styles.aboutCardIcon}>📱</span>
                <h4 style={styles.aboutCardTitle}>Apply via WhatsApp</h4>
                <p style={styles.aboutCardText}>One tap opens a WhatsApp message to the employer. No forms to fill</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={styles.section}>
        <div style={styles.sectionInner}>
          <div style={styles.twoColGrid}>
            ...
            {/* Who We Serve */}
            <div>
              <h2 style={{ ...styles.sectionTitle, marginBottom: '16px' }}>Who This Is For</h2>
...
const styles = {
  ...
  // About
  aboutGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', alignItems: 'start' },
  aboutText: {},
  ...
  ctaText: { fontSize: '15px', color: 'rgba(255,255,255,0.85)', marginBottom: '32px', lineHeight: '1.7', maxWidth: '560px', margin: '0 auto 32px' },
}
