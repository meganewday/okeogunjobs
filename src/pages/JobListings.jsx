...
const CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .oj-card:hover { transform: translateY(-3px); box-shadow: 0 8px 22px rgba(22,163,74,0.1); }
  .oj-btn {
  ...
  .oj-btn-green:hover  { background: #15803d; }
  ...
  .oj-job-title-link {
    color: #14532d; text-decoration: none; font-size: 17px; font-weight: 800;
    display: block; margin-bottom: 3px; transition: color 0.15s;
  }
  .oj-job-title-link:hover { color: #16a34a; }
`
        ...
        <div style={{ flex: 1, width: '100%' }}>
          {loading ? (
            ...
            <div style={{ background: '#fff', borderRadius: 20, padding: '48px 24px', textAlign: 'center', border: '1.5px dashed #bbf7d0' }}>
              ...
              {hasFilters && <button onClick={clearFilters} className="oj-btn oj-btn-green">Clear Filters</button>}
            </div>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  <div key={job.id} className="oj-card" style={{ animationDelay: `${i * 0.05}s` }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12, gap: 12 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
                        {logoUrl && (
                          <img src={logoUrl} alt={job.employers?.organization_name}
                            style={{ width: 40, height: 40, borderRadius: 10, objectFit: 'contain', border: '1.5px solid #dcfce7', flexShrink: 0 }}
                      ...
                      <div style={{ display: 'flex', gap: 6, flexShrink: 0, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                        ...
                        <span style={{ padding: '4px 12px', background: '#dcfce7', color: '#166534', borderRadius: 20, fontSize: 12, fontWeight: 700, whiteSpace: 'nowrap', textTransform: 'capitalize' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #f0fdf4', paddingTop: 14, flexWrap: 'wrap', gap: 8 }}>
                      ...
                      <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                        {whatsappLink && (
                          <a href={whatsappLink} target="_blank" rel="noreferrer" className="oj-btn oj-btn-wa">WhatsApp</a>
                        )}
                        {user && profile && (
                          hasApplied ? (
                            ...
                            <span style={{ padding: '9px 14px', background: '#fef9c3', color: '#854d0e', borderRadius: 50, fontSize: 13, fontWeight: 600 }} title={blockReason}>
                              Not eligible
                            </span>
                          ) : !isApplying ? (
