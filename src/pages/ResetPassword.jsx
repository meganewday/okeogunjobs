      ...
      <div style={styles.page}>
        <div style={styles.card}>
          ...
          <p style={styles.subtitle}>
            We sent a password reset link to <strong>{email}</strong>. Open the link
            in your email to set a new password. Check your spam folder if you do not
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>
          Enter the email address on your {APP_NAME} account. We will send you a
...
const styles = {
  ...
  btn: { display: 'inline-block', width: '100%', padding: '13px', backgroundColor: '#1a6b3c', color: '#fff', fontSize: '15px', fontWeight: '600', border: 'none', borderRadius: '8px', cursor: 'pointer', textDecoration: 'none', textAlign: 'center', boxSizing: 'border-box' },
