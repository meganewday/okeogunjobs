...
export default function JobDetail() {
  ...
  const canApplyOnPlatform = job.application_method === 'platform' || job.application_method === 'both';
  const canApplyWhatsApp = job.application_method === 'whatsapp' || job.application_method === 'both' || job.application_method === 'phone';
