      ...
      <div style={styles.successWrap}>
        <div style={styles.successBox}>
          ...
          <p style={styles.successText}>
            Your profile has been received and is under review. Once approved, employers
            on {APP_NAME} will be able to find you. This usually takes no more than 24 hours.
          </p>
        </div>
      </div>
    )
